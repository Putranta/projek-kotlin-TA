...
public final class FragmentFavoritesBinding implements ViewBinding {
  ...
  private FragmentFavoritesBinding(@NonNull CoordinatorLayout rootView,
      @NonNull FloatingActionButton addItem, @NonNull Toolbar toolbar) {
  ...
  public static FragmentFavoritesBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      id = R.id.addItem;
      FloatingActionButton addItem = ViewBindings.findChildViewById(rootView, id);
      if (addItem == null) {
        break missingId;
      }
      ...
      return new FragmentFavoritesBinding((CoordinatorLayout) rootView, addItem, toolbar);
    }
